...
public class Bank{
    ...
    private static Bank manager = new Bank();
    ...
    private void createAccount(String accountNumber, String accountHolder) {
    ...
    private void depositToAccount(String accountNumber, double amount) {
	...
	private void transferBetweenAccounts(String fromAccount, String toAccount, double amount) {
